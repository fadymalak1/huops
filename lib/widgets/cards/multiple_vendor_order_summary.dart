...
class MultipleVendorOrderSummary extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return VStack(
      [
        "Order Summary".tr().text.semiBold.xl.color(Colors.white).make().pOnly(bottom: Vx.dp12),
        //vendor fees like tax summary
        ...vendorAmounts(context, taxes, vendors, subtotals),
        Divider(thickness: 2,color: Color(0xff575270),).py4(),
        //
        AmountTile(
          "Subtotal".tr(),
  ...
  List<Widget> vendorAmounts(
    ...
    for (var i = 0; i < taxes.length; i++) {
      ...
      Widget widget = VStack(
        [
          "${vendor.name}".text.bold.color(Color(0xffD53C25)).lg.make(),
          AmountTile(
            "Subtotal".tr(),
          ...
          //
          Divider(thickness: 2,color: Color(0xff575270),),
          AmountTile(
            "Total".tr(),
          ...
          // DottedLine(dashColor: context.textTheme.bodyLarge!.color!.withOpacity(0.3),),
        ],
