...
import 'package:huops/views/pages/booking/booking.page.dart';
import 'package:huops/views/pages/commerce/commerce.page.dart';
import 'package:huops/views/pages/food/food.page.dart';
import 'package:huops/views/pages/grocery/grocery.page.dart';
import 'package:huops/views/pages/parcel/parcel.page.dart';
import 'package:huops/views/pages/pharmacy/pharmacy.page.dart';
...
import 'package:huops/views/pages/search/product_search.page.dart';
import 'package:huops/views/pages/search/search.page.dart';
import 'package:huops/views/pages/search/service_search.page.dart';
import 'package:huops/views/pages/service/service.page.dart';
import 'package:huops/views/pages/service/storage_bags_page.dart';
import 'package:huops/views/pages/taxi/taxi.page.dart';
import 'package:huops/views/pages/vendor/vendor.page.dart';
  ...
  static Widget vendorTypePage(
    ...
    switch (vendorType.slug) {
      ...
      case "pharmacy":
        ...
        break;
      case "service":
        homeView = vendorType.id==15 ? StorageBagsPage(vendorType) : ServicePage(vendorType);
        break;
      case "booking":
