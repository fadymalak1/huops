...
class AppColor {
  ...
  static Color get primaryColor => Vx.hexToColor("#8F5298");

  static Color get primaryColorDark => Vx.hexToColor("#8F5298");
  ...
  static Color get deliveryColor => Colors.deepOrange;
  //Vx.hexToColor(colorEnv('deliveryColor'));
